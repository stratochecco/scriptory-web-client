...
import { arrayToBinaryString, binaryStringToArray, decodeBase64, encodeBase64 } from './sycrypto/sycrypto';

import { AUTH_TOKEN_KEY, PASSWORD_HASH_KEY } from './constants';
import { getRandomValues } from './sycrypto/random';

// Thanks to ProtonMail for this idea.
...
const secureSessionStorage = function() {
    ...
    const whitelist = [AUTH_TOKEN_KEY, PASSWORD_HASH_KEY];
    ...
    for (let i = 0; i < whitelist.length; i++) {
        ...
        if (typeof item !== 'string' || typeof nameItem !== 'string') {
            continue;
        }
